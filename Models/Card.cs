...
public record Card
{
    ...
    [MaxLength(3)]
    public string? AccountEncoderId { get; init; }
    ...
    /// <summary>
    /// Month of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. <c>Format: MM</c>. Possible values: 01 through 12.
    /// <para>
    ...
    [MaxLength(1)]
    public string? TypeSelectionIndicator { get; init; }
