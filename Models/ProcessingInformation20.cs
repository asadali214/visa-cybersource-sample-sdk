...
public record ProcessingInformation20
{
    /// <summary>
    ...
    ///   <item><description>Use <c>BILLING_AGREEMENT_CREATE</c> when Paypal billing agreements service is requested.</description></item>
    ///   <item><description>Use <c>UPDATE_AGREEMENT</c></description></item>
    ///   <item><description>Use <c>CANCEL_AGREEMENT</c></description></item>
    ///   <item><description>Use <c>AP_UPDATE_AGREEMENT</c> when Alternative Payment update mandate service is requested.</description></item>
    ///   <item><description>Use <c>AP_CANCEL_AGREEMENT</c> when Alternative Payment revoke mandate service is requested.</description></item>
    ///   <item><description>Use <c>AP_REFRESH_AGREEMENT_STATUS</c> when Alternative Payment mandate status service is requested.</description></item>
    /// </list>
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
