...
public record AmountDetails36
{
    ...
    /// Set this field to the converted amount that was returned by the DCC provider. You must include either this field or the 1st line item in the order and the specific line-order amount in your request. For details, see <c>grand_total_amount</c> field description in <see href="http://apps.cybersource.com/library/documentation/dev_guides/DCC_FirstData_SCMP/DCC_FirstData_SCMP_API.pdf">Dynamic Currency Conversion For First Data Using the SCMP API</see>.
    /// </para>
    /// <para>
    /// #### FDMS South
    /// If you accept IDR or CLP currencies, see the entry for FDMS South in "Authorization Information for Specific Processors" of the <see href="https://developer.cybersource.com/docs/cybs/en-us/api-fields/reference/all/rest/api-fields/order-info-aa/order-info-amount-details-total-amount.html">REST API Fields Guide</see>
    /// </para>
    /// <para>
    /// #### DCC for First Data
    /// Not used.
    /// For details, see <see href="https://developer.cybersource.com/docs/cybs/en-us/api-fields/reference/all/rest/api-fields/order-info-aa/order-info-amount-details-total-amount.html">REST API Field Guide</see>
    /// </para>
    /// </summary>
