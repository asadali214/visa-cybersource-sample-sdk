...
public record PtsV2PaymentsCapturesPost201Response
{
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("_links")]
    public Links4? Links { get; init; }
    ...
    public ProcessorInformation8? ProcessorInformation { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("orderInformation")]
    public OrderInformation7? OrderInformation { get; init; }
    ...
    public EmbeddedActions1? EmbeddedActions { get; init; }
