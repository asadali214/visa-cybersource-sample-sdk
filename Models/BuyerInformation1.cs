...
public record BuyerInformation1
{
    /// <summary>
    ...
    /// <summary>
    /// The buyer’s Alipay login Id, the id might be an email or mobile number. The id is partially masked for privacy. cao<b>*@126.com  or 186</b>*22156
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
