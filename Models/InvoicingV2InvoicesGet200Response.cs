...
public record InvoicingV2InvoicesGet200Response
{
    ...
    public IReadOnlyList<MerchantDefinedFieldValuesWithDefinition>? MerchantDefinedFieldValuesWithDefinition { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("invoiceHistory")]
    public IReadOnlyList<InvoiceHistory>? InvoiceHistory { get; init; }
