...
public record PtsV2CapturesRefundsPost201Response
{
    ...
    public ClientReferenceInformation11? ClientReferenceInformation { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("refundAmountDetails")]
    public RefundAmountDetails? RefundAmountDetails { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("processingInformation")]
    public ProcessingInformation6? ProcessingInformation { get; init; }
