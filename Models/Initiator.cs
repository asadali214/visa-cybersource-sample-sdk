...
public record Initiator
{
    ...
    /// <para>
    /// Valid values:
    /// - <c>true</c> means merchant will use this transaction to store payment credentials for follow-up merchant-initiated transactions.
    /// - <c>false</c> means merchant will not use this transaction to store payment credentials for follow-up merchant-initiated transactions.
    /// </para>
    /// <para>
    ...
    public MerchantInitiatedTransaction? MerchantInitiatedTransaction { get; init; }
