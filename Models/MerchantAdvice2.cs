...
public record MerchantAdvice2
{
    /// <summary>
    /// <list type="bullet">
    ///   <item><description>Merchant should update their retry logic to ensure retry is not attempted for the cards for which Issuer won’t approve the transactions and where the retry is allowed.</description></item>
    ///   <item><description>Card Processing Associations provides this data which is being passed through in the following data element irrespective of the Card Associations.   Usage of this data must be always associated with the Card Associations card types for merchant processing retry logic.</description></item>
    ///   <item><description>In additions to the Merchant Advice code, Associations also provides the decline response codes which provides the reason for decline.  Association response code will be a pass-through value.</description></item>
    /// </list>
    /// <para>
