...
/// </summary>
public sealed class RetrievalSummaries
{
    private readonly RawClient _rawClient;
    private readonly Server _server;

    internal RetrievalSummaries(RawClient rawClient, Server server)
    {
    ...
    public Task GetRetrievalSummary(DateTimeOffset startTime,
        DateTimeOffset endTime,
        string? organizationId,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/reporting/v3/retrieval-summaries"),
            [],
