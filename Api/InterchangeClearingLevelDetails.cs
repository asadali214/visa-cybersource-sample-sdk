...
/// </summary>
public sealed class InterchangeClearingLevelDetails
{
    private readonly RawClient _rawClient;
    private readonly Server _server;

    internal InterchangeClearingLevelDetails(RawClient rawClient, Server server)
    {
    ...
    public Task GetInterchangeClearingLevelDetails(DateTimeOffset startTime,
        DateTimeOffset endTime,
        string? organizationId,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/reporting/v3/interchange-clearing-level-details"),
            [],
