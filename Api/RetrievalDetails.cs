...
public sealed class RetrievalDetails
{
    ...
    internal RetrievalDetails(RawClient rawClient, Server server)
    {
    ...
    public Task GetRetrievalDetails(DateTimeOffset startTime,
        DateTimeOffset endTime,
        string? organizationId,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/reporting/v3/retrieval-details"),
            [],
