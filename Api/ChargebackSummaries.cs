...
/// </summary>
public sealed class ChargebackSummaries
{
    private readonly RawClient _rawClient;
    private readonly Server _server;

    internal ChargebackSummaries(RawClient rawClient, Server server)
    {
    ...
    public Task GetChargebackSummaries(DateTimeOffset startTime,
        DateTimeOffset endTime,
        string? organizationId,
        RequestOptions? requestOptions = null,
        CancellationToken ct = default) =>
        _rawClient.Execute(_server.Default("/reporting/v3/chargeback-summaries"),
            [],
